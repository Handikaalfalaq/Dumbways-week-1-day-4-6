...
let typescript = document.querySelector(".typescript input[type='checkbox']").checked;
  ...
  for (let i = 0; i < blogs.length; i++) {
    for (let i = 0; i < blogs.length; i++) {
      ...
      <div class="blog_project">
          <div class="foto_blog" style="background-image: url(${blogs[i].getinput_image}); background-size: cover; background-position: center center;" ></div>
